    ...
    return (
        <View className='flex h-full justify-center  border-red-700 items-center bg-slate-100'>
            <View className=' bg-white p-2 rounded-md shadow-md w-[300px]'>
                <Text className='text-xl text-center mb-3 mt-5 font-bold'>Register</Text>
                <View className='p-2'>
                    ...
                    <View className='mt-2 flex-row items-center  w-full border mb-2 h-10 rounded-full'>
                        ...
                        <View className='w-[84%] flex-row  items-center '>
                            ...
                            <View className="">
                                {
                                    showConfirmPassword ? <Svg onPress={()=>{setShowConfirmPassword(!showConfirmPassword)}} width={24} height={24} viewBox="0 0 24 24" fill="none">
                                        <Defs>
                                            <ClipPath id="clip0_210_378">
                                                <Rect width={24} height={24} fill="white" />
                                            </ClipPath>
                                    ...
                                    </Svg> : <Svg onPress={()=>{setShowConfirmPassword(!showConfirmPassword)}} width={24} height={24} viewBox="0 0 24 24" fill="none">
                                        <Defs>
                                            <ClipPath id="clip0_210_393">
                                                <Rect width={24} height={24} fill="white" />
                                            </ClipPath>
